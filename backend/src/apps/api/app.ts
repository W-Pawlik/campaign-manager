...
export function createApiApp(options: CreateApiAppOptions): Express {
  ...
  const campaignMonstersController = options.container.get<CampaignMonstersController>(
    API_TYPES.CampaignMonstersController,
  );
  ...
  const campaignQuestsController = options.container.get<CampaignQuestsController>(
    API_TYPES.CampaignQuestsController,
  );
  const campaignNotesController = options.container.get<CampaignNotesController>(
    API_TYPES.CampaignNotesController,
  );
  const campaignSessionsController = options.container.get<CampaignSessionsController>(
    API_TYPES.CampaignSessionsController,
  );
  const externalOpen5eController = options.container.get<ExternalOpen5eController>(
    API_TYPES.ExternalOpen5eController,
  );
