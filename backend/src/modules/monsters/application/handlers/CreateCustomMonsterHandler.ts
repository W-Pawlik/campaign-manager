...
import type { CreateCustomMonsterCommand } from "@modules/monsters/application/commands/CreateCustomMonsterCommand";
...
export class CreateCustomMonsterHandler implements CommandHandler<CreateCustomMonsterCommand, MonsterDetailsDTO> {
  public constructor(
    private readonly monsterRepository: MonsterRepository,
    private readonly accessService: CampaignAccessApplicationService,
  ) {}

  public async execute(command: CreateCustomMonsterCommand): Promise<MonsterDetailsDTO> {
    ...
    const monster = Monster.create({
      ...
      visibility: command.input.visibility === undefined ? MonsterVisibility.gmOnly() : MonsterVisibility.create(command.input.visibility),
