...
export interface CreateCustomMonsterInput {
  campaignId: string;
  actorUserId: string;
  name: string;
...
export class CreateCustomMonsterCommand implements Command<MonsterDetailsDTO> {
  public constructor(public readonly input: CreateCustomMonsterInput) {}
}
