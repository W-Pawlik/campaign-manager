...
import type { UnequipInventoryItemCommand } from "@modules/items/application/commands/UnequipInventoryItemCommand";
...
export class UnequipInventoryItemHandler implements CommandHandler<UnequipInventoryItemCommand, InventoryItemDTO> {
  public constructor(
  ...
  public async execute(command: UnequipInventoryItemCommand): Promise<InventoryItemDTO> {
    ...
    const updatedItem = item.unequip();
